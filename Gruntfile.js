...
module.exports = function(grunt) {
  ...
  grunt.config.init({
    ...
    preprocess: {
      ...
      build: {
        files: {
          'dist/jquery.promises.js' : 'src/jquery.promises.js',
          'dist/amd/jquery.promises.js' : 'src/amd.js'
        }
      },
      interactive: {
        files: {
    ...
    concat: {
      ...
      build: {
        src: 'dist/jquery.promises.js',
        dest: 'dist/jquery.promises.js'
      },
      amd_banner: {
        src: 'dist/amd/jquery.promises.js',
        dest: 'dist/amd/jquery.promises.js'
      }
    },
    ...
    uglify: {
      ...
      amd: {
        src : 'dist/amd/jquery.promises.js',
        dest : 'dist/amd/jquery.promises.min.js'
      },
      core: {
        src: 'dist/jquery.promises.js',
        dest: 'dist/jquery.promises.min.js'
      }
    },
    ...
    jshint: {
      ...
      component: 'src/jquery.promises.js'
    },
